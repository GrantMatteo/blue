function Invoke-SecureBaseline {
    ...
    if ($OS -notmatch "ista|2008|2003|XP|xp|Xp|7") {
        ...
        Write-Host 2
        "yes" | reg add "HKLM\System\CurrentControlSet\Services\LanmanServer\Parameters" /v NullSessionPipes /t REG_MULTI_SZ /d "" /f
        Write-Host 3
        "yes" | reg add "HKLM\System\CurrentControlSet\Services\LanmanServer\Parameters" /v NullSessionShares /t REG_MULTI_SZ /d "" /f
        Write-Host 4
        ######### Logging#########
