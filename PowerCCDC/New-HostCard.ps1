function Invoke-Inventory {
    param (
        ...
        if($null -eq (Get-TrelloBoard -Name $BoardName)) {
            ...
            $BoxCard = New-TrelloCard -ListID (Get-TrelloList -BoardId (Get-TrelloBoard -Name $BoardName | Select-Object -ExpandProperty id) | Select-Object name,id | Where-Object name -eq $OS | Select-Object -expand id) -Name $CardTitle -Description "# System Information:
## Operating System:
